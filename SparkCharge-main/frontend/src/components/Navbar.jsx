...
const Navbar = () => {
    ...
    return (
        <>
            <div ref={ref}></div>
            <motion.nav
                className={`w-full h-[4rem] z-30 px-10 py-5 grid  grid-cols-3 grid-rows-1 duration-300   fixed top-0  ${
                    inView && pathname == "/"
                        ? "text-white bg-transparent"
                        : " text-black bg-[#f8f1ffe2] backdrop-blur-sm "
                }`}
            >
                <div className="col-span-1 flex-box justify-start h-full ">
                    <img
                        src={electric}
                        alt=""
                        className=" h-[3rem]  object-cover"
                    />
                    <h1 className=" text-2xl font-bold">EV Charging Bunk</h1>
                </div>
                    ...
                    <div className=" w-full col-span-1 flex-box justify-end ">
                        <div className=" relative group ">
                            ...
                            <div className=" absolute flex-box  invisible opacity-0 flex-col gap-2 p-2 bg-violet-200 top-10 -right-5 text-violet-900 group-hover:visible group-hover:opacity-100 duration-300 text-md font-[600] rounded-xl">
                                <Link
                                    to={"/profile"}
                                    className="flex-box justify-start w-full  gap-2 hover:text-violet-100 hover:bg-violet-400 p-3 duration-150 w-full rounded-xl"
                                >
                                    <User size={25} />
                                    Profile
                                </Link>
                                ...
                                <Link
                                    to={"/profile/booking"}
                                    className="flex-box justify-start w-full  gap-2 hover:text-violet-100 hover:bg-violet-400 p-3 duration-150  rounded-xl"
                                >
                                    <ShoppingBag size={25} />
                                    Bookings
                                </Link>
                                <button
                                    ...
                                    className="flex-box justify-start gap-2 hover:bg-red-500 hover:text-red-100 text-red-600 p-3 duration-150 w-full rounded-xl"
                                >
                                    <LogOut />
                                    SignOut
                                </button>
