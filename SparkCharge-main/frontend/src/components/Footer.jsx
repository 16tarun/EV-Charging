        ...
        <div class="md:flex md:justify-between gap-10">
          <div class="mb-6 md:mb-0">
              <a class="flex items-center">
                  <span class="self-center text-3xl font-semibold poppins whitespace-nowrap text-violet-400">EV 
                      Charging Bunk
                  </span>
              </a>
              <p className=' mt-4 md:mt-16 text-xl text-white'>New Building,<br />Pratap Nagar, Shastri Nagar<br /> Jaipur, Rajasthan 302016</p>
          </div>
